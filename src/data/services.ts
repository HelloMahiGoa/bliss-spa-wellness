...
export const services: Service[] = [
  {
    ...
    priceLabel: inr(2199),
    metaTitle:
      "Relaxation massage in GTB Nagar from ₹2,199 | Blissful Spa & Wellness",
    metaDescription:
      "Unwind with a calm, full-body massage on Hudson Lane—light to medium pressure, private room, 60 minutes from ₹2,199. Near Kingsway Camp and North Campus. Call 7678623255 to book.",
    paragraphs: [
  ...
  },
  {
    ...
    priceLabel: inr(899),
    metaTitle:
      "Head & scalp massage in GTB Nagar from ₹899 | Blissful Spa & Wellness",
    metaDescription:
      "Ease headaches, eye strain, and desk fatigue with a focused head, scalp, and neck session—30 minutes from ₹899 in a quiet Hudson Lane spa, Delhi.",
    paragraphs: [
  ...
  },
  {
    ...
    priceLabel: inr(2499),
    metaTitle:
      "Aromatherapy massage in GTB Nagar from ₹2,499 | Blissful Spa & Wellness",
    metaDescription:
      "Swedish-style flow with essential oils you choose—relaxing, aromatic, and tailored to you. 60 minutes from ₹2,499 at Blissful Spa on Hudson Lane, GTB Nagar.",
    paragraphs: [
  ...
  },
  {
    ...
    priceLabel: inr(1299),
    metaTitle:
      "Foot & leg massage in GTB Nagar from ₹1,299 | Blissful Spa & Wellness",
    metaDescription:
      "Revive tired feet and calves after long Delhi days—gentle, thorough foot and lower-leg work in a calm space. 45 minutes from ₹1,299 on Hudson Lane.",
    paragraphs: [
      ...
      "Students and office workers near DU North Campus and Kingsway Camp often book this as a standalone lunch-hour reset—no need to commit to a full hour on the table.",
  ...
  },
  {
    ...
    duration: "90 minutes (massage + steam)",
    priceInr: 3199,
    priceLabel: inr(3199),
    metaTitle:
      "Massage + private steam in GTB Nagar from ₹3,199 | Blissful Spa & Wellness",
    metaDescription:
      "Therapeutic massage plus a private steam session in one visit—deep relaxation and that spa-finished feeling. 90 minutes from ₹3,199 on Hudson Lane, GTB Nagar.",
    paragraphs: [
    ...
    highlights: [
      "Massage + private steam",
      "90 minutes total",
      "Hydration-friendly pacing",
      "Weekend favourite",
    ],
    seoKeywords: [
  ...
  },
  {
    ...
    priceLabel: inr(499),
    metaTitle:
      "Private steam session in GTB Nagar from ₹499 | Blissful Spa & Wellness",
    metaDescription:
      "A short, peaceful steam break when you want warmth and quiet without a full massage. 20 minutes from ₹499 on Hudson Lane—call 7678623255 to book.",
    paragraphs: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "About 20 minutes of steam time, plus a few minutes to settle in and cool down—plan a little buffer after.",
      },
      {
        question: "How do I book?",
        answer:
  ...
  },
  {
    ...
    priceLabel: inr(2899),
    metaTitle:
      "Balinese massage in GTB Nagar from ₹2,899 | Blissful Spa & Wellness",
    metaDescription:
      "Stretch, acupressure, and flowing oil massage in one session—energising yet deeply relaxing. 90 minutes from ₹2,899 at Blissful Spa, Hudson Lane, Delhi.",
    paragraphs: [
      ...
      "If you have been searching for Balinese massage near Kingsway Camp or GTB Nagar metro, book a 90-minute window so we never rush the lower body and back sequence.",
      ...
      "Popular with guests who want more movement than pure relaxation massage but less pinpoint intensity than deep tissue. Call or WhatsApp to reserve—weekend 90-minute slots go first.",
    ],
    benefits: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Balinese routines cover back, legs, arms, neck, and often feet with time for stretch sequences—shorter slots would feel rushed.",
      },
      {
        question: "How do I book?",
        answer:
  ...
  },
  {
    ...
    priceLabel: inr(2299),
    metaTitle:
      "Swedish massage in GTB Nagar from ₹2,299 | Blissful Spa & Wellness",
    metaDescription:
      "Classic relaxation massage with strokes that ease tension and support circulation—great if you are new to massage. 60 minutes from ₹2,299 on Hudson Lane, Delhi.",
    paragraphs: [
  ...
  },
  {
    ...
    duration: "60 minutes · two guests",
    priceInr: 4599,
    priceLabel: inr(4599),
    priceNote: "per couple",
    metaTitle:
      "Couple massage in GTB Nagar from ₹4,599 | Blissful Spa & Wellness",
    metaDescription:
      "Side-by-side massage in a private, calm room—ideal for date nights and celebrations. From ₹4,599 per couple on Hudson Lane, North Delhi. Book ahead.",
    paragraphs: [
  ...
  },
  {
    ...
    priceLabel: inr(3899),
    metaTitle:
      "Massage + jacuzzi in GTB Nagar from ₹3,899 | Blissful Spa & Wellness",
    metaDescription:
      "Warm hydrotherapy and hands-on massage in one visit—bubbles and bodywork when you want a real treat. 75 minutes from ₹3,899 on Hudson Lane, GTB Nagar.",
    paragraphs: [
  ...
  },
  {
    ...
    priceLabel: inr(2799),
    metaTitle:
      "Deep tissue massage in GTB Nagar from ₹2,799 | Blissful Spa & Wellness",
    metaDescription:
      "Slower, stronger work for knots, gym soreness, and desk-tight muscles—depth you can still breathe through. 60 minutes from ₹2,799 on Hudson Lane, Delhi.",
    paragraphs: [
  ...
  },
  {
    ...
    priceLabel: inr(1199),
    metaTitle:
      "Stress-relief back massage in GTB Nagar from ₹1,199 | Blissful Spa & Wellness",
    metaDescription:
      "Focused upper, mid, and lower back work when you are short on time—ease desk hunch and driving tension. 45 minutes from ₹1,199 on Hudson Lane, GTB Nagar.",
    paragraphs: [
      ...
      "No need to block a full hour—45 minutes is designed for real relief without eating your whole afternoon. We are on Hudson Lane above Mr Crust, a quick detour for many GTB Nagar and Kingsway Camp routines.",
  ...
  },
  {
    ...
    priceLabel: inr(2999),
    metaTitle:
      "Thai massage (stretch-based) in GTB Nagar from ₹2,999 | Blissful Spa & Wellness",
    metaDescription:
      "Assisted stretching and compression on a mat—stay comfortably clothed and leave feeling longer and looser. 90 minutes from ₹2,999 on Hudson Lane, Delhi.",
    paragraphs: [
      ...
      "Book all 90 minutes—Thai routines need time for legs, hips, back, and neck. Blissful Spa, Hudson Lane near Uttam Chai, welcomes students and professionals from across North Delhi.",
    ],
    benefits: [
    ...
    faqs: [
      ...
      },
      {
        question: "How do I book?",
        answer:
          "Call +91 7678623255 or WhatsApp. Reserve the full 90-minute slot in advance.",
      },
    ],
  },
  {
    ...
    priceLabel: inr(3299),
    metaTitle:
      "Hot stone massage in GTB Nagar from ₹3,299 | Blissful Spa & Wellness",
    metaDescription:
      "Smooth heated stones and flowing massage for deep, cosy relaxation—lovely after cold days or long commutes. 75 minutes from ₹3,299 on Hudson Lane, GTB Nagar.",
    paragraphs: [
    ...
    faqs: [
      ...
      },
      {
        question: "How do I book?",
        answer:
          "Phone +91 7678623255 or WhatsApp. Allow 75 minutes plus arrival time.",
      },
    ],
  },
  {
    ...
    priceLabel: inr(2699),
    metaTitle:
      "Sports massage in GTB Nagar from ₹2,699 | Blissful Spa & Wellness",
    metaDescription:
      "Recovery-focused massage for runners, gym-goers, and anyone who trains—flush sore muscles and move easier. 60 minutes from ₹2,699 on Hudson Lane, Delhi.",
    paragraphs: [
